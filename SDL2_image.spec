...
Source0  : https://www.libsdl.org/projects/SDL_image/release/SDL2_image-2.8.5.tar.gz
Source1  : https://www.libsdl.org/projects/SDL_image/release/SDL2_image-2.8.5.tar.gz.sig
Source2  : 30A59377A7763BE6.pkey
Summary  : image loading library for Simple DirectMedia Layer
Group    : Development/Tools
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause libtiff
...
%setup -q -n SDL2_image-2.8.5
cd %{_builddir}/SDL2_image-2.8.5
pushd ..
cp -a SDL2_image-2.8.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739225003
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2_image-2.0.so.0.800.5
/usr/lib64/libSDL2_image-2.0.so.0
/usr/lib64/libSDL2_image-2.0.so.0.800.5
